...
void Service_Tool (void) 
{
  ...
  while (Service == 1) 
  {
      ...
      {    
        ...
        else if (b == 'W') toggleWASDebug();
        else if (b == 'H') ISO129029();
        else if (b == 'K') ISO65267();
        else if (b == 'J') ISO65254();
...
void Help(){
  ...
  if(sendGPStoISOBUS_129029) Serial.println("H = Stop sending ISO 129029");
  else Serial.println("H = Start sending ISO 129029");
  if(sendGPStoISOBUS_65254) Serial.println("J = Stop sending ISO 65254");
  else Serial.println("J = Start sending ISO 65254");
  if(sendGPStoISOBUS_65267_65256) Serial.println("K = Stop sending ISO 65267 65256");
  else Serial.println("K = Start sending ISO 65267 65256");
  Serial.println("W = toggle WAS Data debug");
...
void ISO129029(){
    ...
    sendGPStoISOBUS_129029 = !sendGPStoISOBUS_129029;

    if(sendGPStoISOBUS_129029) Serial.println("ISO 129029 enabled");
    else Serial.println("ISO 129029 disabled");
...
void ISO65254(){
    ...
    sendGPStoISOBUS_65254 = !sendGPStoISOBUS_65254;
    if(sendGPStoISOBUS_65254) Serial.println("ISO 65254 enabled");
    else Serial.println("ISO 65254 disabled");
...
void ISO65267(){
    ...
    sendGPStoISOBUS_65267_65256 = !sendGPStoISOBUS_65267_65256;
    if(sendGPStoISOBUS_65267_65256) Serial.println("ISO 65267 65256 enabled");
    else Serial.println("ISO 65267 65256 disabled");
...
void CatMT() {
    EEPROM.update(70, 8);
    Brand = EEPROM.read(70);
    Serial.println("Brand Set Cat MT Late, Restarting Teensy");
    delay(1000);
    SCB_AIRCR = 0x05FA0004; //Teensy Reset
    Serial.println(" ");
}
...
//**************************************************************************************
void toggleWASDebug() {
    if (WASDebug) { WASDebug = false; Serial.println("WAS debug OFF, Send X To Exit Service Tool"); Help(); }
    else { WASDebug = true; Serial.println("WAS debug ON, send 'W' to turn OFF\nSend X To Exit Service Tool"); }
    delay(2000);
    Serial.println();
}
//**************************************************************************************
