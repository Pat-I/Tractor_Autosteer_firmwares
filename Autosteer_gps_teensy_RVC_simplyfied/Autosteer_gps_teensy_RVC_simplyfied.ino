...
//
//modified by Pat 28/04/2023 BNO_RVC.cpp removed the yaw reset
//
//
// connection plan:
...
String inoVersion = ("\r\nFirmware Version !! RVC simplyfied !!, 2024.05.18 - by Pat\r\n");
...
elapsedMicros ASloopTimeUs = 0;
elapsedMicros BNOreadTime = 0;
...
void loop()
{
  ...
  if(ASloopTimeUs > 5000) // it takes more than 5ms print a warning
  {
    Serial.print("WARNING! Main Loop time Us= ");
    Serial.println(ASloopTimeUs);
  }
